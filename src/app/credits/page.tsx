        ...
        transition={{ duration: 0.5, ease: "easeOut" }}>
            ...
            <div className="relative bg-[url('/images/LuddeWater.jpg')] bg-cover bg-center h-54 w-full flex justify-center items-center">
                ...
                <div className="relative z-10 text-white p-4 flex justify-center">
                    <p className="text-white text-center text-lg max-sm:text-sm">
            ...
            <div className="relative bg-[url('/images/DomkyrkanUnder.jpg')] bg-cover bg-center h-84 max-sm:h-68 w-full flex justify-center items-center">
                <div className="absolute inset-0 bg-black/50" />
                <div className="relative z-10 text-white flex items-center justify-around w-full">

                    {/*Mauritz*/}
                    <div className="flex flex-col items-center">
                        <div className="w-40 h-40 max-sm:h-25 max-sm:w-25 rounded-xl">
                            <img 
                            src="images/Omslag_Skam.jpg"
                            alt="Cover"
                            className="w-full h-full object-cover rounded-2xl outline-1 outline-secondary" />
                        </div>
                        <h1 className="max-sm:text-xs my-1">Tabletten by Mauritz</h1>
                        <a
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="max-sm:text-xs my-1">My Spotify</h1>
                        <a
                    ...
                    {/*SoundCloud*/}
                    <div className="flex flex-col items-center">
                        <div className="w-40 h-40 max-sm:h-25 max-sm:w-25 rounded-xl bg-black">
                            <img 
                            src="/images/Logo.png"
                            alt="Cover"
                            className="w-full h-full object-cover rounded-2xl outline-1 outline-secondary" />
                        </div>
                        <h1 className="max-sm:text-xs my-1">My Souncloud</h1>
                        <a
